<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Main.Master" AutoEventWireup="true" CodeBehind="frmCreateVendors.aspx.cs" Inherits="WebApplication2.Forms.frmCreateVendors" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Container" runat="server">
  ...
  <br />
                                    <h3><strong>CREATE VENDORS</strong> </h3>
  ...
  <br />
            ...
            <br />
                                  ...
                                  <div class="form-group input-group">
                                           ...
                                           <%-- chechbox IsActive --%>
                                            <asp:CheckBox ID="cbIsActive" runat="server"  placeholder="IsActive"
