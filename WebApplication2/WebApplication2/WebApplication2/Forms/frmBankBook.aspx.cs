...
{
    public partial class frmBankBook : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
             ...
             if (!IsPostBack)
            {
                ...
                DataTable dt = blayer.BpCashAccounts();
        ...
        public void transition()
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("usp_BankBookMasterTransaction");
            ...
            if (ViewState["CurrentTable"] != null)
            {
                ...
                if (dtCurrentTable.Rows.Count > 0)
                {
                    for (int i = 1; i <= dtCurrentTable.Rows.Count; i++)
                    {
                        ...
                        //txtTotalCredit.Text =boxCredit.Text;
                         aa = int.Parse(boxAmount.Text);
                            bb = bb + aa;
                          cc = bb;
                          dd=int.Parse(txtTotal.Text);
                    ...
                    {
                        lblMessage2.Text = "No Value Is Entered";
                    }
                        if(cc != dd)
                    {

                        lblMessage2.Text = "Diference In Amounts";
                        }
        ...
        protected void btnNewBankBook_Click(object sender, EventArgs e)
        {
            Response.Redirect("frmBankBook.aspx");
        }
