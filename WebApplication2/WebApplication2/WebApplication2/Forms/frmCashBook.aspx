<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Main.Master" AutoEventWireup="true" CodeBehind="frmCashBook.aspx.cs" Inherits="WebApplication2.frmCashBook" %>
            ...
            <div class="form-group input-group">
                ...
                <div class="checkbox">
                    <label class="btn btn-default">
                        <asp:RadioButton ID="rbReceipt" Text="Receipt" GroupName="1" runat="server" AutoPostBack="True" OnCheckedChanged="rbReceipt_CheckedChanged" />
                    </label>
                    <div class="checkbox">
                        <label class="btn btn-default">
                            <asp:RadioButton ID="rbPayment" Text="Payment" GroupName="1" runat="server" AutoPostBack="True" OnCheckedChanged="rbPayment_CheckedChanged" />
                        </label>
                        <br />
                        <br />
                    ...
                    <div class="form-group input-group">
                        ...
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Width="700px" Height="150px" OnRowCreated="GridView1_RowCreated" ShowFooter="True" OnRowDataBound="GridView1_RowDataBound" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" BorderColor="Chocolate">
                            <Columns>
                                    ...
                                    <ItemTemplate>
                                        <asp:DropDownList ID="ddlAccountCode" runat="server">
                                            ...
                                            <%--<asp:ListItem Value="2">Liability</asp:ListItem>
                                              ...
                                              <asp:ListItem Value="4">Revenue</asp:ListItem>
                                              <asp:ListItem Value="5">Expenses</asp:ListItem>--%>
                                        </asp:DropDownList>
                                    </ItemTemplate>
                                </asp:TemplateField>
                    ...
                    <div class="form-group input-group">
                        ...
                        <asp:Button ID="btnPrintReport" runat="server" Text="Print Report" CssClass="tn-primary alert-success" Visible="false" OnClick="btnPrintReport_Click" />
                        <asp:Button ID="btnNewCashBook" runat="server" Text="New Cash Book" CssClass="tn-primary alert-success" Visible="false" OnClick="btnNewCashBook_Click" />
